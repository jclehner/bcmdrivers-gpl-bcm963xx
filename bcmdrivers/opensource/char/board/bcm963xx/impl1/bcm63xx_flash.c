...
void kerSysEarlyFlashInit( void )
{
    ...
    defined(CONFIG_BCM96836)  || defined(CONFIG_BCM963158) || defined(CONFIG_BCM96846) || defined(CONFIG_BCM96856)
...
#endif
        {
            ...
            {
                /* We should never get here, NVRAM should either be present in dtb
                 * or it should have been read from raw flash devices. We either 
                 * have forgotten to add the NVRAM to dtb OR we have the wrong flash
                 * device selected */
