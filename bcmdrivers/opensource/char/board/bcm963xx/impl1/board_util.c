...
int kerSysGetPciePortEnable(int port)
{
    ...
    if ((port == 0) || (port == 1) || (port == 3)
        ...
        ret = 0;
#elif defined (CONFIG_BCM96846) || defined (CONFIG_BCM96856) // XXX DIMA Check
    if ((port==0) || (port==1))
        ret = 1;
    else
        ret = 0;
...
#elif defined (CONFIG_BCM96836) || defined (CONFIG_BCM96856) // XXX DIMA Check
    ret = 1;
#elif defined (CONFIG_BCM96846)
    if ((port==0) || (port==1))
        ret = 1;
...
{
    int ret = 1;
#if defined (CONFIG_BCM96838) || defined (CONFIG_BCM96848) || defined(CONFIG_BCM96858) || defined(CONFIG_BCM96846)
    ret = 0;
#endif    
