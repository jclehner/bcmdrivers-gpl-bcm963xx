...
typedef enum
{
    ...
    RDPACTL_IC_TYPE_IP_FLOW = 4,   /**< Classification type IP_Flow (XRDP) */
} rdpactl_ic_type;
...
typedef struct
{
    ...
    uint32_t generic_mask;    /**< mask per flow for generic key / used for XRDP */
