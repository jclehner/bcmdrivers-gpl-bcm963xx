...
BCMADSL_STATUS BcmAdsl_StartBERT(unsigned char lineId, UINT32 totalBits);
BCMADSL_STATUS BcmAdsl_StopBERT(unsigned char lineId);
BCMADSL_STATUS BcmAdsl_BertStartEx(unsigned char lineId, UINT32 bertSec);
...
BCMADSL_STATUS BcmAdsl_StartBERT(UINT32 totalBits);
BCMADSL_STATUS BcmAdsl_StopBERT(void);
BCMADSL_STATUS BcmAdsl_BertStartEx(UINT32 bertSec);
