...
extern phy_drv_t phy_drv_6836_egphy;
extern phy_drv_t phy_drv_6836_sgmii;
extern phy_drv_t phy_drv_6836_54810;
...
#endif
#ifdef PHY_6836_EGPHY
    ret |= phy_driver_set(&phy_drv_6836_egphy);
#endif
#ifdef PHY_6836_SGMII
    ret |= phy_driver_set(&phy_drv_6836_sgmii);
#endif
#ifdef PHY_6836_54810
    ret |= phy_driver_set(&phy_drv_6836_54810);
#endif
#ifdef PHY_EXT1
...
int phy_drivers_init(void)
{
    ...
    ret |= phy_driver_init(PHY_TYPE_6836_EGPHY);
    ret |= phy_driver_init(PHY_TYPE_6836_SGMII);
    ret |= phy_driver_init(PHY_TYPE_6836_54810);
