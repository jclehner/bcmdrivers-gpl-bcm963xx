...
extern bus_drv_t bus_6836_int_drv;
extern bus_drv_t bus_6836_ext_drv;
...
bus_drv_t *bus_drv_get(bus_type_t bus_type)
{
    ...
    case BUS_TYPE_6836_INT:
        bus_drv = &bus_6836_int_drv;
        break;
    case BUS_TYPE_6836_EXT:
        bus_drv = &bus_6836_ext_drv;
        break;
#endif
