...
{
#if !(defined(CONFIG_BCM96836) || defined(CONFIG_BCM963158) || defined(CONFIG_BCM96846))
   BPCM_PWR_ZONE_N_CONTROL bpcmPwrZoneControl;
   BPCM_SR_CONTROL sr_control;
#endif

#if defined(CONFIG_BCM96858) || defined(CONFIG_BCM96836) || defined(CONFIG_BCM963158) || defined(CONFIG_BCM96846)
