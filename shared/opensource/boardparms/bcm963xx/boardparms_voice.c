...
static VOICE_DAUGHTER_BOARD_PARMS * g_94908_dCardList[] = {
   SLICSLAC_LIST_COMMON_FXO,
   SLICSLAC_LIST_ZSI_FXO,
   0
};

static bp_elem_t g_voice_bcm94908ref[] = {
   ...
   {bp_daughterCardList,        .u.ptr = g_94908_dCardList},
   {bp_last}
};

static bp_elem_t g_voice_bcm962118ref[] = {
   {bp_cpBoardId,               .u.cp = "962118REF"},
   {bp_elemTemplate,            .u.bp_elemp = g_voice_bcm94908ref},
   {bp_last}
};
...
static VOICE_DAUGHTER_BOARD_PARMS * g_96836_dCardList[] = {
   SLICSLAC_LIST_COMMON_NOFXO,
   SLICSLAC_LIST_ZSI_NOFXO,
   0
};

static bp_elem_t g_voice_bcm96836ref[] = {
   {bp_cpBoardId,               .u.cp = "968360GREF"},
   {bp_usFxsFxo1SpiSSNum,       .u.us = SPI_DEV_1},
   {bp_usGpioFxsFxoRst1,        .u.us = BP_GPIO_3_AL},
   {bp_daughterCardList,        .u.ptr = g_96836_dCardList},
   {bp_last}
};

static bp_elem_t g_voice_bcm96836pmd[] = {
   {bp_cpBoardId,               .u.cp = "968360PMD"},
   {bp_elemTemplate,            .u.bp_elemp = g_voice_bcm96836ref},
   {bp_last}
};
...
#if !defined(_BCM963268_) && !defined(CONFIG_BCM963268) && !defined(_BCM96838_) && !defined(CONFIG_BCM96838) && !defined(_BCM963138_) && !defined(CONFIG_BCM963138) && !defined(_BCM963381_) && !defined(CONFIG_BCM963381) && !defined(_BCM963148_) && !defined(CONFIG_BCM963148) && !defined(CONFIG_BCM96848) && !defined(_BCM94908_) && !defined(CONFIG_BCM94908) && !defined(_BCM96858_) && !defined(CONFIG_BCM96858) && !defined(_BCM96836_) && !defined(CONFIG_BCM96836) && !defined(_BCM963158_) && !defined(CONFIG_BCM963158) && !defined(CONFIG_BCM96846)
