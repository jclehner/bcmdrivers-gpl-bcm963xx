...
#define INTERRUPT_PER_BT_UARTINT          (SPI_TABLE_OFFSET + 34)
...
#define INTERRUPT_ID_UART1                (bcm_legacy_irq_map[INTERRUPT_PER_BT_UARTINT - SPI_TABLE_OFFSET])
