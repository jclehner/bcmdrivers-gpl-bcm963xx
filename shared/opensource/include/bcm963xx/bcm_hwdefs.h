...
/*****************************************************************************/
#if defined(_BCM963138_) || defined(CONFIG_BCM963138) || defined(_BCM963148_) || defined(CONFIG_BCM963148) || defined(_BCM94908_) || defined(CONFIG_BCM94908) || defined(_BCM947189_) || defined(CONFIG_BCM947189) || defined(_BCM96846_) || defined(CONFIG_BCM96846)
...
/*****************************************************************************/
#if ( defined(_BCM96846_) || defined(CONFIG_BCM96846) || defined(_BCM963158_) || defined(CONFIG_BCM963158) || defined(_BCM96836_) || defined(CONFIG_BCM96836) || defined(CONFIG_BCM96858) || defined(_BCM96858_) || defined(_BCM96856_) || defined(CONFIG_BCM96856)) && !defined(CONFIG_BRCM_IKOS)
...
#define ASTRA_BASE_ADDR_STR         "astra"
...
#define NVRAM_DATA_MIRROR_INFO "/data/nvram_data.info"
#define MAX_NVRAM_MIRROR_LOOKUP_OFFSET 20*1024*1024
#define MAX_NVRAM_MIRRORS 10
typedef struct
{
        int active_idx;
        unsigned long offset[MAX_NVRAM_MIRRORS];
        unsigned long validity[MAX_NVRAM_MIRRORS];
        unsigned long write_fail_count[MAX_NVRAM_MIRRORS];
}NVRAM_MIRROR_INFO;
