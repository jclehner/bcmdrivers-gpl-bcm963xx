...
#define SDRAM_CTRL_BASE             (REG_BASE + 0x00000000)  /* SDRAM Control */
#define ENET_CORE0_BASE             (REG_BASE + 0x00400000)
#define ENET_CORE1_BASE             (REG_BASE + 0x00600000)
#define PCIE_BASE                   (REG_BASE + 0x00a00000)  /* PCIE Control */
#define BRIDGE_BASE                 (REG_BASE + 0x01000000)
...
#define STRAP_BASE                  (REG_BASE + 0x01e00304)  /* Strap Override Control Registers */
#define BSTI_BASE                   (REG_BASE + 0x01e003f8)  /* Serial Interface Control registers */
#define OTP_BASE                    (REG_BASE + 0x01e00400)  /* OTP Controller registers */
#define UART_BASE                   (REG_BASE + 0x01e00500)  /* UART registers */
#define PERIPH_MUTEX_BASE           (REG_BASE + 0x01e00700)  /* Periph Mutex registers */
