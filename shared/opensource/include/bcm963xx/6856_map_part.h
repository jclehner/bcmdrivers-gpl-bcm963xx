...
#define CHIP_FAMILY_ID_HEX	        0x6856
...
#define NGPON2_PHYS_BASE            0x82db4000
...
#define TOP_CNTRL_OFFSET            0x5a000
...
#define TOP_CNTRL_BASE              (PERF_PHYS_BASE + TOP_CNTRL_OFFSET)  /* chip top control registers*/
...
#define TOP_CTRL_BASE               BCM_IO_MAP(PERF1_IDX, PERF1_PHYS_BASE, TOP_CTRL_OFFSET)
...
#define DG_TRIM_SHIFT   0
   ...
   uint32      _2P5vDetectCtl;     // 0x70
   uint32       OrionIntPending;   // 0x74 
} TopControl;

#define TOP ((volatile TopControl * const) TOP_CNTRL_BASE)
...
#define MISC_STRAP_BUS_BOOTROM_BOOT_N           (0x1 << 11)
    ...
    uint32  miscSpare0;                         /* 0x38 */
    uint32  miscSWdebugNW[2];                   /* 0x3c-0x40 */
    uint32  miscWDenReset;                      /* 0x44 */
} Misc;
...
typedef struct SecureRangeCheckers {
   ...
   RangeCtrl RANGE_CTRL[8];/* 0x10 - 0xcc */
...
#define MEMC_ARB_CFG_BURST_MODE_MASK    (0x1<<MEMC_ARB_CFG_BURST_MODE_SHIFT)
   ...
   uint32 unused12[48];              /* 0x400-0x4bf */
   ...
   uint32 unused27[58];              /* 0xe18-0xeff */
   ...
   uint32 unused28[567];            /* 0xf24-0x17ff */

   SecureRangeCheckers SEC_RANGE_CHK; /* 0x1800-0x18ff */
   uint32 unused29[31168];            /* 0x1900-0x200000 */
...
{
  uint32 config;
#define BCM6856_IUDMA_CONFIG_ENDMA       0x0001
#define BCM6856_IUDMA_CONFIG_PKTHALT     0x0002
#define BCM6856_IUDMA_CONFIG_BURSTHALT   0x0004

  uint32 intStat;
#define BCM6856_IUDMA_INTSTAT_BDONE   0x0001
#define BCM6856_IUDMA_INTSTAT_PDONE   0x0002
#define BCM6856_IUDMA_INTSTAT_NOTVLD  0x0004
#define BCM6856_IUDMA_INTSTAT_MASK    0x0007
#define BCM6856_IUDMA_INTSTAT_ALL     BCM6856_IUDMA_INTSTAT_MASK

  uint32 intMask;
#define BCM6856_IUDMA_INTMASK_BDONE   0x0001
#define BCM6856_IUDMA_INTMASK_PDONE   0x0002
#define BCM6856_IUDMA_INTMASK_NOTVLD  0x0004

  uint32 maxBurst;
#define BCM6856_IUDMA_MAXBURST_SIZE 16 /* 32-bit words */
...
#define BCM6856_IUDMA_STRAM_DESC_RING_OFFSET 0x3fff
...
#define BCM6856_MAX_APM_PCM_DMA_CHANNELS 6

typedef struct ApmPcmIudma
{
   ApmPcmIudmaRegisters regs;                                        //
   uint32 reserved1[110];                                             //
   ApmPcmIudmaChannelCtrl ctrl[BCM6856_MAX_APM_PCM_DMA_CHANNELS];    //
   uint32 reserved2[104];                                             //
   ApmPcmIudmaStateRam stram[BCM6856_MAX_APM_PCM_DMA_CHANNELS];      //
...
/* 6856 Kernel space Compilation CL - need to be modified by infrastructure team !!! */
/* not relevant for 6856 platform but stil compile in pon stack */
#define NGPON2_IDX            0
