...
#if !defined(_BCM963268_) && !defined(_BCM96838_) && !defined(_BCM949178_)
...
static int nand_adjust_cfg(PCFE_NAND_CHIP pchip)
{
    ...
    defined(_BCM96836_) || defined(_BCM963158_) || defined(_BCM96846_) || defined(_BCM96856_)
    cfg = NAND->NandConfigExt;
#endif
    ...
    unsigned int page_offset, unsigned char *buffer, int len)
{
    ...
    xfer_buf = KMALLOC(pchip->chip_page_size, 0);

    memset(xfer_buf, 0xff, pchip->chip_page_size);
